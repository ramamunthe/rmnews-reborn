                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('tag.destroy', $tag->id) }}" type="button" class="btn btn-danger btn-sm">Delete</a>
                            <a  href="#editModal{{ $tag->id }}" data-bs-toggle="modal" type="button" class="btn btn-warning btn-sm">Detail</a>
                        </div>
                    </td>
                </tr>
                @endforeach
