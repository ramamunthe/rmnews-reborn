            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="category" name="category_id" value="{{ old('category') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select basic-multiple" name="tags[]" id="tags" multiple value="{{ old('tags[]') }}">
                            @foreach ($tags as $tag)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="image" accept="image/png, image/jpeg" name="image" value="{{ old('image') }}">
                    </div>
                    <div class="mb-3">
